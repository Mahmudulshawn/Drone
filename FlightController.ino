...
void kalman_1d(float KalmanState, float KalmanUncertainty, float KalmanInput, float KalmanMeasurement){
  ...
  KalmanUncertainty = KalmanUncertainty + (0.004 * 0.0004 * 4 * 4);
...
void battery_voltage(void){
  Voltage = (float)analogRead(A5)/62;
  Current = (float)analogRead(21)*0.0089;
}
...
void loop() {
  ...
  if(ReceieverValue[2] < 1050){
    MotorInput1 = ThrolleCutOff;
    MotorInput2 = ThrolleCutOff;
    MotorInput3 = ThrolleCutOff;
    MotorInput4 = ThrolleCutOff;
    reset_pid();
  }
